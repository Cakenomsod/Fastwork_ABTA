...
|--------|--------|----------|
| ชื่อบัญชี | ✅ ได้จากลูกค้า 2 ส.ค. 2569 | สมาคมการค้าผู้ประกอบการห้องเช่า |
...
| รายการ | ค่าในระบบ | สถานะ |
|--------|-----------|--------|
| สมัครใหม่ (รวมค่าแรกเข้า 500) | สามัญ 1,500 / วิสามัญ 1,000 / สมทบ 5,500 | ✅ ตามลูกค้า 2 ส.ค. 2569 |
| ต่ออายุ / เปลี่ยนประเภท | สามัญ 1,000 / วิสามัญ 500 / สมทบ 5,000 | ✅ |

โค้ด: `apps/functions/src/members/fees.ts` + เลือกประเภทบนฟอร์มสมัคร/ต่ออายุ
...
คู่มือเต็ม: [14-Rich-Menu-Guide.md](./14-Rich-Menu-Guide.md)
...
| ปุ่ม “เช็คสถานะ” → ข้อความ `เช็คสถานะ` | ⬜ บอทตอบ Flex แล้ว |
| ปุ่ม “ช่วยเหลือ” → ข้อความ `ช่วยเหลือ` | ⬜ |
