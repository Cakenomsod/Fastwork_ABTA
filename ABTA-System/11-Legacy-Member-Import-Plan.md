...
| **รูปแบบที่ลูกค้าใช้จัดข้อมูล** | อิงไฟล์ที่เคยส่งให้ได้เลย (หัวคอลัมน์เดิม) — ยืนยัน 21 ก.ค. 2569 ดู [12-Scope-Update-2026-07-21.md](./12-Scope-Update-2026-07-21.md) |
