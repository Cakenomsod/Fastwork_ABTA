...
flowchart TD
    ...
    I --> K[แจ้งยืนยันผ่าน LINE OA]
    K --> L[ส่งเข้าระบบหลังบ้าน]
    L --> M[รอแอดมิน/นายทะเบียนตรวจข้อมูล]
    M --> N{ข้อมูลถูกต้อง?}
    N -->|ใช่| O[ใช้เลขสมาชิกเดิม + ออกใบเสร็จชั่วคราว]
...
4. หลังกดส่ง → ออก **Member ID ชั่วคราว** ทันที (ภายใน 5 นาที) — ใบเสร็จชั่วคราวออก**หลังนายทะเบียนอนุมัติข้อมูล**
5. แจ้งยืนยันผ่าน LINE OA (พร้อมเลขสมาชิก) → ส่งเข้า Back Office
...
flowchart TD
    ...
    C --> D{ข้อมูลถูกต้อง?}
    D -->|ใช่| E[อนุมัติข้อมูล — ใช้เลขสมาชิกเดิม + ออกใบเสร็จชั่วคราว]
...
| **นายทะเบียน** | ตรวจสอบข้อมูลสมาชิก, ออกใบเสร็จชั่วคราวเมื่อผ่าน, อนุมัติสมาชิกใหม่/ต่ออายุ/สัมมนา | ขั้นที่ 1 |
