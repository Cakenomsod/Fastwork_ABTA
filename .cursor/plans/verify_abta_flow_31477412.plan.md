...
flowchart TD
    subgraph userFlow [Flow ที่คุณสรุป]
        ...
        A3 --> A5[ออกเลขสมาชิกชั่วคราว + ใบเสร็จชั่วคราว]
        A4 --> A5
        A5 --> A6[แอดมินตรวจข้อมูล]
        A6 -->|ผ่าน| A7[ใช้เลขเดิม + ใบเสร็จชั่วคราว]
    ...
    subgraph docFlow [Flow ในเอกสาร Phase 1]
        ...
        B4 --> B5[แจ้ง LINE OA]
        B5 --> B6[นายทะเบียน/แอดมินตรวจ ข้อมูล + สลิป รวมกัน]
        B6 -->|ผ่าน| B7[สมาชิกสมบูรณ์ + เลขถาวร]
...
**ที่คุณสรุป:**
- ออกใบเสร็จชั่วคราวทันทีหลังสมัคร
...
flowchart TD
    ...
    backoffice --> review[เจ้าหน้าที่ตรวจ ข้อมูล + สลิป]
    review -->|ผ่าน| approved[สมาชิกสมบูรณ์ + เลขถาวร]
    review -->|ไม่ผ่าน| reject[แจ้งให้แก้ไข/ส่งใหม่]
