...
flowchart TD
    subgraph userFlow [Flow ที่คุณสรุป]
        ...
        A6 -->|ผ่าน| A7[ใช้เลขเดิม + ออกใบเสร็จชั่วคราว]
    ...
    subgraph docFlow [Flow ในเอกสาร Phase 1]
        ...
        B6 -->|ผ่าน| B6a[ออกใบเสร็จชั่วคราว]
        B6a --> B6b[เหรัญญิกตรวจสลิป]
        B6b -->|ผ่าน| B7[สมาชิกสมบูรณ์ + เลขถาวร + ใบเสร็จตัวจริง]
...
| ถ้าผ่าน → ได้เลขถาวร (promote จากชั่วคราว) | ตรง — `memberId: ชั่วคราว → ถาวร` ([07-Tech-Stack.md](ABTA-System/07-Tech-Stack.md)) |
